...
CREATE TABLE AuditLog (LogID NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY, TransactionID NUMBER, AccountID NUMBER, Amount NUMBER, TransactionType VARCHAR2(10), LogDate DATE);
